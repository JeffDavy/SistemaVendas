 ...
 */
public class VendedorArea extends javax.swing.JFrame {
    ...
    public void preencheTabela() {
        ...
        vendBean.setEstadoAtual("Ativo");
        
        ArrayList<Vendedor> listaVendedor = vendControl.listarController(vendBean);
        
        if (listaVendedor.size() > 0) {
            
            DefaultTableModel tmVendedor= new DefaultTableModel();
            
            tmVendedor.addColumn("Código");
            tmVendedor.addColumn("Nome");
            tmVendedor.addColumn("CPF");
            tmVendedor.addColumn("Data de Nascimento");
            tmVendedor.addColumn("Contato 1");
            ...
            for (Object obj : listaVendedor) {
                ...
                tmVendedor.addRow(new String[1]);
                
                tbl_vendedores.setValueAt(venBean.getCodVendedor(), i, 0);
                tbl_vendedores.setValueAt(venBean.getNome(), i, 1);
                tbl_vendedores.setValueAt(venBean.getCpf(), i, 2);
                tbl_vendedores.setValueAt(venBean.getDataNascimento(), i, 3);
                tbl_vendedores.setValueAt(venBean.getContato1(), i, 4);
    ...
    public void preencheTabelaNome(Vendedor vendBean) {
       
        vendBean.setEstadoAtual("Ativo");
        
        ArrayList<Vendedor> listaVendedor = vendControl.listarNomeController(vendBean);
    ...
    private void initComponents() {
        ...
        tbl_vendedores.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(40, 40, 40), 1, true));
        tbl_vendedores.setFont(new java.awt.Font("Berlin Sans FB", 0, 14)); // NOI18N
        ...
        tbl_vendedores.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tbl_vendedores.setGridColor(new java.awt.Color(40, 40, 40));
        tbl_vendedores.setSelectionBackground(new java.awt.Color(0, 95, 72));
        jScrollPane1.setViewportView(tbl_vendedores);
        if (tbl_vendedores.getColumnModel().getColumnCount() > 0) {
            tbl_vendedores.getColumnModel().getColumn(0).setResizable(false);
            tbl_vendedores.getColumnModel().getColumn(1).setResizable(false);
            tbl_vendedores.getColumnModel().getColumn(2).setResizable(false);
            tbl_vendedores.getColumnModel().getColumn(3).setResizable(false);
            tbl_vendedores.getColumnModel().getColumn(4).setResizable(false);
        }
    ...
    private void btn_adicionarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_adicionarMouseClicked
        VendedorCRUD home = new VendedorCRUD("Adicionar Vendedor");
        home.show();
        this.dispose();
    ...
    private void btn_editarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_editarMouseClicked
        ...
        if (linhaSelecionada >= 0) {
            ...
            VendedorCRUD tela = new VendedorCRUD("Editar Vendedor");
    ...
    private void btn_removerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_removerMouseClicked
        ...
        if (linhaSelecionada >= 0) {
            ...
            vendBean.setCodVendedor(codVendedor);
            vendBean.setEstadoAtual("Offline");
            
            int result = JOptionPane.showConfirmDialog(this, "Deseja exluir o vendedor selecionado?", "Excluir", JOptionPane.YES_NO_OPTION);
            
            if (result == JOptionPane.YES_OPTION) {

                if (result == JOptionPane.YES_OPTION) {

                    boolean status = vendControl.statusController(vendBean);

                    if (status) {

                        JOptionPane.showMessageDialog(null, "Vendedor desativado com sucesso!", "Sucesso!", JOptionPane.INFORMATION_MESSAGE);
                        preencheTabela();

                    } else {

                        JOptionPane.showMessageDialog(null, "Vendedor não desativado", "ERRO", JOptionPane.ERROR_MESSAGE);
    ...
    private void txt_buscaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscaKeyTyped
        ...
        Vendedor venBean = new Vendedor();
        
        venBean.setNome(txt_busca.getText());
        
        preencheTabelaNome(venBean);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendedorArea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VendedorArea().setVisible(true);
            }
        });
    }
